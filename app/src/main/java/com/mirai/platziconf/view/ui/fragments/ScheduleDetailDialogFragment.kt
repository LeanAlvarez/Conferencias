...
class ScheduleDetailDialogFragment: DialogFragment()  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvDetailCoferenceHour.text = date
        tvDetailCoferenceSpeaker.text = conference.speaker
        tvDetailCoferenceTag.text = conference.tag
        tvDetailCoferenceDescription.text = conference.description
